    ...
    while True:
        ...
        if success:
            ...
            if(capture):
                ...
                p = os.path.sep.join(['shots', "me.jpg"])
                cv2.imwrite(p, frame)
...
# @app.route('/what',methods=['POST','GET'])
# def wha():

#     email = 'roughitsrinivasan17@gmail.com'
#     password = 'hnftqszsmeaeylen'
...
#     img_data = open("shots/me.jpg", 'rb').read()
